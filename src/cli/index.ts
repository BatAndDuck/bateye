...
export function createCLI(): Command {
  ...
  program
    ...
    .description('List available AI models (optionally filter by provider, e.g. openai, anthropic, google, mistral, vercel, groq, xai, cohere, deepseek, bedrock, azure, togetherai, fireworks, litellm)')
